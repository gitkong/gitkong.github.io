...
# 8、__typeof__(self) strongSelf = weakSelf; 的使用[解答地址](https://dhoerl.wordpress.com/2013/04/23/i-finally-figured-out-weakself-and-strongself/)
>总结
...
# 23、宏定义的 __attribute__((visibility ("default")))  作用
